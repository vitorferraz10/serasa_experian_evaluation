  ...
  font: {
    ...
    size: {
      desktop: {
        ...
        heading_s: tokens.font.size.desktop.heading_s,
        heading_xs: tokens.font.size.desktop.heading_xs,
      ...
      mobile: {
        ...
        heading_s: tokens.font.size.mobile.heading_s,
        heading_xs: tokens.font.size.mobile.heading_xs,
      },
    },
    weight: {
